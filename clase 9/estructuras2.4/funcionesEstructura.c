...
int menu()
{
    ...
    printf("7- Contar Empleados por sector\n");
    printf("8- Salir\n\n");
...
void mostrarEmpleados(eEmpleado vec[], int tam, eSector sectores[], int tamSectores)
{
    ...
    printf("\n\n legajo  nombre  sexo  sueldo       Fecha Nac        Sector\n");
    for(int i=0; i < tam; i++)
    {
        if(vec[i].ocupado == 1)
        {
...
void altaEmpleado(eEmpleado vec[], int tam, eSector sectores[], int tamSectores)
{
    ...
    else
    {
        ...
        if( esta == -1)
        {
            ...
            scanf("%d %d %d", &vec[indice].fechaNac.dia, &vec[indice].fechaNac.mes, &vec[indice].fechaNac.anio);
...
void mostrarSectoresConEmpleados(eSector sectores[], int tamSectores, eEmpleado emp[], int tamEmpleados){
    ...
    for(int i=0; i<tamSectores; i++){
            ...
            for(int j=0; j<tamEmpleados; j++){
                ...
                if(sectores[i].id == emp[j].idSector && (emp[j].ocupado == 1)){

                        mostrarEmpleado(sectores, tamSectores, emp[j]);
                }
            }
...
void mostrarCantEmpleadosXSector(eSector sectores[], int tamSectores, eEmpleado emp[], int tamEmpleados){
    ...
    for(int i=0; i<tamSectores; i++){
        ...
        printf("%s : %d\n\n", sectores[i].descripcion, contador);
    }
}
